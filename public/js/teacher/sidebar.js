...
function handleViewReport(link){
  link.addEventListener("click",e=>{
    ...
    .then(data=>{
      ...
      "Companies participated :"+report.companies.length+" <br>Students placed :"+report.students.length+"<br>Placement percentage : 98%<br>Departments participated : 14<br>Average package : 7 LPA"
  })
